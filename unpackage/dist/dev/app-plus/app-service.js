...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === \"string\") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === \"Object\" && o.constructor) n = o.constructor.name;if (n === \"Map\" || n === \"Set\") return Array.from(o);if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      mobile: '',\n      page: 1,\n      list_main: [] };\n\n  },\n  onLoad: function onLoad() {\n    if (uni.getSystemInfoSync().platform === 'android') {\n      this.mobile = 'android';\n    } else {\n      this.mobile = 'other';\n    }\n    this.getList(false, 1);\n    this.getList(false, false);\n  },\n  onPullDownRefresh: function onPullDownRefresh() {var _this = this;\n    setTimeout(function () {\n      uni.stopPullDownRefresh();\n      _this.getList(false, 1);\n    }, 1000);\n  },\n  onReachBottom: function onReachBottom() {var _this2 = this;\n    var page = this.page = this.page + 1;\n    uni.showToast({\n      icon: 'loading',\n      duration: 1100 });\n\n    setTimeout(function () {\n      _this2.getList(true, page);\n    }, 1000);\n  },\n  methods: {\n    getList: function getList(bottom, page) {var _this3 = this;\n      var list = [];\n      if (!bottom && page) {\n        uni.request({\n          url: 'https://www.bilibili.com/index/ding.json?page=' + this.page,\n          success: function success(res) {\n            _this3.list_main = res.data.douga;\n          } });\n\n      } else if (bottom && page) {\n        list = Object.values(this.list_main);\n        uni.request({\n          url: 'https://www.bilibili.com/index/ding.json?page=' + page,\n          success: function success(res) {\n            var more_list = Object.values(res.data.douga);\n            _this3.list_main = [].concat(_toConsumableArray(list), _toConsumableArray(more_list));\n          } });\n\n      }\n    },\n    search: function search() {\n      uni.navigateTo({\n        url: '../search/search' });\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///13\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {};\n\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///34\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {};\n\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///39\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {};\n\n\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///44\n");
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "view",
            { staticClass: _vm._$s(19, "sc", "fe"), attrs: { _i: 19 } },
            [
              _c("uni-icons", {
                attrs: {
                  type: "star-filled",
      ...
      _vm._l(_vm._$s(23, "f", { forItems: _vm.moreVideo }), function(
        item,
        index,
        $20,
        $30
        ...
        return _c(
          ...
          [
            _c(
              "navigator",
              {
                staticClass: _vm._$s("24-" + $30, "sc", "video_list"),
                attrs: {
                  url: _vm._$s(
                    "24-" + $30,
                    "a-url",
              ...
              [
                _c("image", {
                  staticClass: _vm._$s("25-" + $30, "sc", "video_img"),
                  attrs: {
                    src: _vm._$s("25-" + $30, "a-src", item.pic),
                    _i: "25-" + $30
                  }
                }),
                _c(
                  "view",
                  {
                    staticClass: _vm._$s("26-" + $30, "sc", "video_info"),
                    attrs: { _i: "26-" + $30 }
                  },
                  [
                    _c(
                      "text",
                      {
                        staticClass: _vm._$s("27-" + $30, "sc", "video_title"),
                        attrs: { _i: "27-" + $30 }
                      },
                    ...
                    _c(
                      "view",
                      {
                        staticClass: _vm._$s("28-" + $30, "sc", "up_main"),
                        attrs: { _i: "28-" + $30 }
                      },
                      [
                        _c(
                          "view",
                          {
                            staticClass: _vm._$s("29-" + $30, "sc", "up_name"),
                            attrs: { _i: "29-" + $30 }
                          },
                          [
                            _c("uni-icons", {
                        ...
                        _c(
                          "view",
                          {
                            staticClass: _vm._$s("32-" + $30, "sc", "video_in"),
                            attrs: { _i: "32-" + $30 }
                          },
                          [
                            _c(
      ...
      _vm._$s(39, "i", _vm.bottom) ? _c("view", [_c("text")]) : _vm._e()
    ],
    2
  )
}
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      src: '',\n      title: '',\n      ownerImg: '',\n      ownerName: '',\n      vInfo: '',\n      videoUrl: '',\n      moreVideo: [],\n      bottom: false,\n      videoImg: '' };\n\n  },\n  onLoad: function onLoad(option) {var _this = this;\n    uni.request({\n      url: 'https://tenapi.cn/bilivideo/',\n      data: {\n        url: 'https://www.bilibili.com/video/' + option.id },\n\n      success: function success(res) {\n        if (_this.title == '') {\n          _this.title = res.data.title;\n          uni.setNavigationBarTitle({\n            title: res.data.title });\n\n        }\n        _this.src = res.data.url;\n      } });\n\n    uni.setNavigationBarTitle({\n      title: option.title });\n\n    this.title = option.title;\n    this.ownerImg = option.img;\n    this.ownerName = option.name;\n    this.vInfo = option.desc;\n    this.videoImg = option.pic;\n    this.videoUrl = 'https://www.bilibili.com/video/' + option.id;\n    uni.request({\n      url: 'http://api.bilibili.com/x/web-interface/archive/related',\n      data: {\n        bvid: option.id },\n\n      success: function success(res) {\n        _this.moreVideo = res.data.data;\n        _this.bottom = !_this.bottom;\n      } });\n\n  },\n  methods: {\n    onShare: function onShare() {\n      uni.shareWithSystem({\n        summary: this.title,\n        href: this.videoUrl });\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///60\n");
